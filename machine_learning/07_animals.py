#https://www.kaggle.com/code/stpeteishii/animals-90-pytorch-lightning-cnn
import os
import random
import numpy as np
import pandas as pd
...
dataset0=datasets.ImageFolder(root="./datasets/animals",transform=None)
...
class DataModule(pl.LightningDataModule):
    ...
    def __init__(self, transform=transform, batch_size=32):
        super().__init__()
        self.root_dir = "./datasets/animals"
